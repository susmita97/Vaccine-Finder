...
<!DOCTYPE html>
  <html>
	...
	<h5>You just declined an appointment.<br>Go to Book an Appointment to book another one.</h5><br><br>
	<h5>Go to Appointment History now to review the details.</h5><br><br>
	 ...
	 <?php 
				...
				$sql="update status_of_app set status='declined', provider_notified='yes' where patient_id=$id and app_id=$app_id";
