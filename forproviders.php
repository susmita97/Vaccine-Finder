	...
	<br><br><br>
	  ...
	  <div class="row">
        ...
        <div class="col s12 offset-m4 m6 offset-l4 l5">
          ...
          <h2 class="blue-text text-darken-2">For Provider</h2><br>
	  ...
	  <div class="row">
        ...
        <div class="col s12 offset-m4 m6 offset-l4 l5">
          ...
          <h2 class="teal-text text-accent-4">Lost your way? <br>No worries. <br>Sign Up/Login as a Patient</h2><br>
	   ...
	   <div class="row">
					...
					<h4 class="center-align blue-text text-darken-4">Contact Us</h4><br>
					<p class="center-align blue-text">Have questions? You can email us your queries at vaccinefinder@gmail.com. Just click the blue button on the bottom right hand side of the page.</p>
					<br><br><br>
					</div>
					</div> 
		</div>
