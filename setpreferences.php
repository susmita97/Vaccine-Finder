	  ...
	  <form action='#' method = 'post'>
        ...
        <tbody>
          <tr>
            ...
            <td>
			<button class="btn waves-effect waves-light center" type="submit" name="Monday">Set</button>
			</td>
          </tr>
		  ...
		  <tr>
            ...
            <td>
			<button class="btn waves-effect waves-light center" type="submit" name="Tuesday">Set</button>
			</td>
          </tr>
		  ...
		  <tr>
            ...
            <td>
			<button class="btn waves-effect waves-light center" type="submit" name="Wednesday">Set</button>
			</td>
          </tr>
		  ...
		  <tr>
            ...
            <td>
			<button class="btn waves-effect waves-light center" type="submit" name="Thursday">Set</button>
			</td>
          </tr>
		  ...
		  <tr>
            ...
            <td>
			<button class="btn waves-effect waves-light center" type="submit" name="Friday">Set</button>
			</td>
          </tr>
		  ...
		  <tr>
            ...
            <td>
			<button class="btn waves-effect waves-light center" type="submit" name="Saturday">Set</button>
			</td>
          </tr>
		  ...
		  <tr>
            ...
            <td>
			<button class="btn btn-medium waves-effect waves-light center" type="submit" name="Sunday">Set</button><br><br>
			</td>
          </tr>
